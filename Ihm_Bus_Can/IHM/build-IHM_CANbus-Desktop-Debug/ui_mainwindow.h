...
"rgb(255, 0, 0)"));
        ...
        horizontalSlider_vit->setGeometry(QRect(49, 130, 441, 20));
        ...
        groupBox_2->setGeometry(QRect(180, 190, 451, 311));
...
"background-color: rgb(143, 240, 164);"));
        ...
        lblMPAccX->setObjectName(QString::fromUtf8("lblMPAccX"));
        lblMPAccX->setGeometry(QRect(30, 50, 91, 20));
        lblMPAccY = new QLabel(groupBox_2);
        lblMPAccY->setObjectName(QString::fromUtf8("lblMPAccY"));
        ...
        lblMPAccZ->setObjectName(QString::fromUtf8("lblMPAccZ"));
        ...
        lblMPGyrX->setObjectName(QString::fromUtf8("lblMPGyrX"));
        lblMPGyrX->setGeometry(QRect(30, 140, 91, 20));
        lblMPGyrY = new QLabel(groupBox_2);
        lblMPGyrY->setObjectName(QString::fromUtf8("lblMPGyrY"));
        lblMPGyrY->setGeometry(QRect(30, 160, 91, 20));
        lblMPGyrZ = new QLabel(groupBox_2);
        lblMPGyrZ->setObjectName(QString::fromUtf8("lblMPGyrZ"));
...
"background-color: rgb(143, 240, 164);"));
        ...
        QBrush brush39(QColor(252, 175, 62, 128));
