...
void ObjectOpenGL::initializeGL()
{
    ...
    glClearColor(BackGround_Color.redF(), BackGround_Color.greenF(), BackGround_Color.blueF(), BackGround_Color.alphaF());                   // Set backGround color
...
void ObjectOpenGL::Draw_Box()
{
    ...
    // Rear View
    glBegin(GL_POLYGON);
    glColor4ub(0,0,255,128); // Dark Blue ; 128=Transparency
    glVertex3d(-L1, -L2, -L3);
    glVertex3d(-L1,  L2, -L3);
    ...
    glColor4ub(255,102,0,128); // orange
    glVertex3d(-L1, L2,  L3);
    glVertex3d( L1, L2, 0.0);
    glVertex3d(-L1, L2, -L3);
    glEnd();
    ...
    // Bottom View
    glBegin(GL_TRIANGLES);
    glColor4ub(0,255,255,128); // light blue
    glVertex3d(-L1, -L2, L3);
    glVertex3d(-L1, -L2,-L3);
    glVertex3d( L1, -L2, 0.0);
    glEnd();
...
void ObjectOpenGL::Draw_Frame()
{
    ...
    // X-axis
    glBegin(GL_LINES);
    glColor4f(Axis_X_Color.redF(), Axis_X_Color.greenF(), Axis_X_Color.blueF(), Axis_X_Color.alphaF());
    glVertex3d(0,0,0);
    glVertex3d(0.25, 0, 0);
    glEnd();
    // Y-axis
    glBegin(GL_LINES);
    glColor4f(Axis_Y_Color.redF(), Axis_Y_Color.greenF(), Axis_Y_Color.blueF(), Axis_Y_Color.alphaF());
    glVertex3d(0,0,0);
    glVertex3d(0, 0.25, 0);
    glEnd();
    // Z-axis
    glBegin(GL_LINES);
    glColor4f(Axis_Z_Color.redF(), Axis_Z_Color.greenF(), Axis_Z_Color.blueF(), Axis_Z_Color.alphaF());
    glVertex3d(0,0,0);
    glVertex3d(0, 0, 0.25);
    glEnd();
}
...
{
    float delta = event->angleDelta().y() / 1200.0;
    if (delta<0) {
        Zoom /= 1 - delta;
    } else {
        Zoom *= 1 + delta;
