...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__REDLIB__ -D__MULTICORE_M33SLAVE -I"C:\Users\ilias\Music\workspacex (1)\workspacex (1)\workspacex\lpcxpresso55s69_mailbox_interrupt_cm33_core1\lcd" -I"C:\Users\ilias\Music\workspacex (1)\workspacex (1)\workspacex\lpcxpresso55s69_mailbox_interrupt_cm33_core1\drivers" -I"C:\Users\ilias\Music\workspacex (1)\workspacex (1)\workspacex\lpcxpresso55s69_mailbox_interrupt_cm33_core1\source" -g3 -gdwarf-4 -mcpu=cortex-m33+nodsp -mthumb -D__REDLIB__ -specs=redlib.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
